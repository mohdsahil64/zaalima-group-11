          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-border">
              <div>
                ...
                <p className="text-xs text-text-secondary">Receive email updates about your applications</p>
              </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-border">
              <div>
                ...
                <p className="text-xs text-text-secondary">Update your password regularly for security</p>
              </div>
